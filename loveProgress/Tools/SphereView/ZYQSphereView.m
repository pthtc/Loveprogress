...
-(void)changeView{
    ...
    [self rotateSphereByAngle:0 fromPoint:normalPoint toPoint:movePoint];
}
...
- (void)handlePanGesture:(UIPanGestureRecognizer *)panRecognizer {
	switch (panRecognizer.state) {
		...
		case UIGestureRecognizerStateChanged: {
			...
			// Sphere rotation
			[self rotateSphereByAngle:4 fromPoint:normalizedOriginalTouchPoint toPoint:normalizedTouchPoint];
		}
